...
const jsonData = function () {
  return src(path.src.server + '/*.json')
...
exports.build = series(del, minifyImages, minifyIcons, jsonData, htmlInclude, sassProd, scriptsProd);

exports.dev = series(parallel(devImages, devIcons), jsonData, sassDev, scriptsDev, htmlInclude, serve);